function Hline = plotfdtype(fdobj,colortype,linewidth,Lfdobj, matplt, href)
...
if nargin < 4+1+1, href = 1;             end
if nargin < 3+1+1, matplt = 1;           end
if nargin < 2+1+1, Lfdobj = int2Lfd(0);  end
    ...
    if matplt
        ...
        %else
         %   if nargout > 0
              %  Hline = plot (x, fdmat, '-');
          %  else
                plot (x, fdmat, colortype,'LineWidth',linewidth)
          %  end
        end
