...
%  The data are in a struct object called growth.  This object is saved as
%  the .mat file growth.mat.  The following command loads the object.
...
WfdPar = fdPar(fd(zeros(nbasis,ncasem),wbasis), Lfdobj, lambda);

[Wfdm, betam, hgtmhatfd] = smooth_monotone(age, hgtmmat, WfdPar);

% -----------------  Female data  --------------------

WfdPar = fdPar(fd(zeros(nbasis,ncasef),wbasis), Lfdobj, lambda);

[Wfdf, betaf, hgtfhatfd] = smooth_monotone(age, hgtfmat, WfdPar);
...
[Dhgtfregfd, warpfd] = registerfd(Dhgtfmeanfd, Dhgtffd, WfdPar);

[Dhgtfregfd, warpfd] = registerfd(Dhgtfmeanfd, Dhgt, WfdPar);
